 ...
 */
public class MySelfBatisGenerator {
     ...
     */
    public MySelfBatisGenerator(Configuration configuration, ShellCallback shellCallback,
...
//        if (configuration.getClassPathEntries().size() > 0) {
        	/*************HUANGP**start********************/
        	/*新增自己逻辑 修改类加载器加载路径 */
        	List<String> entries=configuration.getClassPathEntries();
        	List<String> urls=new ArrayList<String>();
        	for(String jars:entries){
        		urls.add(System.getProperty("user.dir").concat("/src/main/webapp/WEB-INF/lib/").concat(jars));
        	}
        	/*******************end**********************/
            ClassLoader classLoader = getCustomClassloader(urls);
